    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          InfoLabel(label: 'Customer Name', value: foundOrder.users[0].name),
          const SizedBox(height: 12),
          InfoLabel(label: 'Email', value: foundOrder.users[0].email),
          const SizedBox(height: 12),
          InfoLabel(
            label: 'Phone',
            value: foundOrder.users[0].phoneNumber ?? 'Not provided',
          ),
          const SizedBox(height: 12),
